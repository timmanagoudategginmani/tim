	...
	<body>
		<nav class="navbar-nav navbar-expand-sm bg-info" style="margin:0px;padding:0px;">
			...
			<img src="admin.png" style="border-radius:15%;margin-left:25%;float:left" width="70px" height="80px">
					<h3  style="float:left;cursor:pointer;margin:10px 2px 0px 20px;">ನಿರ್ವಾಹಕ</h3>
						
			</div>
					<div style="width:90%" >
					<a class="btn btn-danger" style="float:right;padding-left:30px;padding-right:30px;margin:10px;" href="adminlogin1.html">Logout</a>
					<a class="btn btn-success" style="float:right;margin:10px;" href="afteradminlogin.php">ಡ್ಯಾಶ್‌ಬೋರ್ಡ್‌ಗೆ ಹಿಂತಿರುಗಿ</a>
			</div>
		
		</nav>
		<div class="container">
		<h2 style="padding-top:10px;">ಪ್ರಗತಿಯಲ್ಲಿರುವ ದೂರನ್ನು ಇಲ್ಲಿ ಪೂರ್ಣಗೊಳಿಸಿ</h2><hr />
			...
			<h5>ಬಳಕೆದಾರ ಹೆಸರು
				...
				<hr />ಇಲ್ಲಿ ಅಭಿಪ್ರಾಯಗಳನ್ನು ನಮೂದಿಸಿ<br />
				...
				<a class="btn btn-light" style="padding-left:2%;padding-right:2%;margin-left:1%;" href="afteradminlogin.php">ಪೋರ್ಟಲ್ ಗೆ ಹಿಂತಿರುಗಿ</a>
			</h3>
			</form>
		</div>
