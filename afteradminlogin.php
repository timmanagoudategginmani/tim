		...
		<nav  class="navbar navbar1 bg-dark" style="float:left;margin:0px;display:block;padding:0px;box-shadow:.2px 1px 2px 1px;" id="sh_menu">
			...
			<ul class="navbar-nav" style="width:100%;">
				...
				<li class="nav-item" id="i_comp"  style="display:none"> 
					<a class="btn btn-dark btn1" onclick="inpro()"  href="#">Under progress<p id="specialchk"><?php echo $inpro;?></p></a>
				</li>
			...
			<h4>>Dashboard<hr /></h4>
				<div id="file1" onclick="pending()" style="cursor:pointer;">
					...
					<div id="file2">
						...
						<p id="file22" style="display:block;font-size:15px;text-align:center;">Under progress complaints<div id="pen2"><?php echo $inpro; ?></div></p>
					</div>
						<div id="file3">
